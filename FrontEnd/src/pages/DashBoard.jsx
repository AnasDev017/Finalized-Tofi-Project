      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        {filteredNumbers.map((num) => (
          <motion.div 
            key={num.id}
            whileHover={{ y: -5 }}
            className="relative overflow-hidden bg-[#111] border border-white/10 rounded-2xl p-5 hover:border-[#ff4da6]/50 transition-all group flex flex-col h-full shadow-lg hover:shadow-[0_0_25px_rgba(255,77,166,0.15)]"
          >
            {/* Soft background glows */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#ff4da6]/5 rounded-full blur-3xl group-hover:bg-[#ff4da6]/15 transition-colors duration-500 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-[#9d4edd]/5 rounded-full blur-2xl group-hover:bg-[#9d4edd]/15 transition-colors duration-500 pointer-events-none" />

            <div className="flex justify-between items-center mb-6 relative z-10">
              <div className="flex items-center gap-2.5 bg-black/50 pr-3 pl-2 py-1.5 rounded-full border border-white/5 backdrop-blur-sm shadow-sm">
            ...
            <div className="flex-grow flex items-center justify-center py-4 relative z-10">
              <h3 className="text-xl sm:text-2xl lg:text-[1.35rem] xl:text-2xl font-mono font-semibold tracking-widest whitespace-nowrap bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 group-hover:from-[#ff4da6] group-hover:to-[#9d4edd] transition-all duration-500">
                {num.number}
              </h3>
            </div>
            ...
            <div className="pt-5 mt-auto border-t border-white/5 flex items-center justify-between relative z-10">
              ...
              <button 
                ...
                className="bg-white/5 hover:bg-gradient-to-r hover:from-[#ff4da6] hover:to-[#9d4edd] border border-white/10 hover:border-transparent text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-300 group-hover:shadow-[0_4px_15px_rgba(255,77,166,0.3)]"
              >
                Get Number
              </button>
            </div>
