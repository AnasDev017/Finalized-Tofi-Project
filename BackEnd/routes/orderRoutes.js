...
import { addOrder, getMyOrders, getAllOrders, updateOrderStatus, buyNumber } from "../controllers/orderController.js";
...
router.post("/buy", tokenVerifcation, buyNumber);                // Instant wallet purchase
